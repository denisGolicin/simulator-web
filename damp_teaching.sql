...
INSERT INTO teaching_subject (subjects_name, status) VALUES
    ('Химия', 'active'),
    ('Физика', 'active'),
    ('История', 'active'),
    ('Биология', 'active'),
...
INSERT INTO teaching_classes (classes_name, status) VALUES
    ('5', 'active'),
    ('6', 'active'),
    ('7', 'active'),
    ('8', 'active'),
...
INSERT INTO teaching_dialogs (question, answer_correct, answer_0, answer_1, answer_2, answer_3, audio_url, image_url, subjects, classes, status) VALUES
