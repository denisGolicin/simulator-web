...
{
    private $conn;
    private $table_name = "teaching_classes";
    ...
    function add($subjects_name, $class_name) {
        ...
        $subject_query = "SELECT id FROM teaching_subject WHERE subjects_name = :subjects_name LIMIT 1";
        ...
        if ($subject_stmt->rowCount() > 0) {
            ...
            $query = "INSERT INTO teaching_dialogs (answer_correct, answer_0, audio_url, image_url, subjects, classes, status)
    ...
    function edit($currentSubjects, $currentClass, $newClass) {
        ...
        $update_dialog_query = "UPDATE teaching_dialogs SET classes = :new_class WHERE subjects = :current_subjects AND classes = :current_class";
    ...
    function delete($subjects_name, $class_name) {
        ...
        if ($class_stmt->rowCount() > 0) {
            ...
            $dialog_query = "DELETE FROM teaching_dialogs WHERE subjects = :subjects_name AND classes = :class_name";
